...
class Solution {
  public:
    ...
    Node* BuildBST(int pre[], int &ind, int mini, int maxi, int size){
        ...
        if(pre[ind]>mini && pre[ind]<maxi){
            ...
            root->left = BuildBST(pre, ind, mini, root->data, size);
            root->right = BuildBST(pre, ind, root->data, maxi, size);
        }
    ...
    Node* Bst(int pre[], int size) {
        ...
        return BuildBST(pre, ind, mini, maxi, size);
    }
};
